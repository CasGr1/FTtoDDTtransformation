...
def PaDAcost(ft, pathsets):
    ...
    if [] in pathsets:
        ...
        return DDT(var, ddtelement=DdtElementType.DEC, children=[PaDAcost(ft, remove_var(pathsets, var)), PaDAcost(ft, remove_ps(pathsets, var))], prob=ftvar.prob, cost=ftvar.cost)
